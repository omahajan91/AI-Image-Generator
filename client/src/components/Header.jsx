...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >Turn text to <span className='text-blue-600' >image</span>, in secounds</motion.h1>
      <motion.p className='text-center max-w-xl mx-auto mt-5'
       initial={{ opacity:0, y:20}}
       animate={{ opacity:1, y:0 }}
       transition={{ delay:0.6, duration:0.8}}
      >
         Unleash your creativity with AI. Turn your imagination into visual art in secounds - just type, and watch the magic happen.
      </motion.p>
